...
fixture.meta('Version', '0.0.1')('Home Page Validation')
    .page('https://devexpress.github.io/testcafe/example/');

test
    .meta('env', 'stage')
    .page('https://devexpress.github.io/testcafe/example/')('Checking Home Page', async t => {
        await t.expect(Selector('#main-form').withText('Example').exists).ok();
    })

test
    .page('https://devexpress.github.io/testcafe/example/')('Filling the Page', async n => {
